...
status: active
year: 2021
tags: [python, cli, health, hci, open-source]
domain: hci
---
...
into the system, and makes the rest of the day easier to concentrate through — the stated aim is
a refreshed, energetic workday and improved concentration through raised oxygen levels.
...
[[mytimer|MyTimer — A Timer for Command Line Enthusiasts]] — the other project grouped under human-computer interaction.
