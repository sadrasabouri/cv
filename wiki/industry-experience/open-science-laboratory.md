---
title: "Open Science Laboratory (OpenSciLab)"
...
Being a co-founder here means wearing every hat the work requires:

- **Full-stack software development** — building and shipping the libraries themselves
- **Software engineering** — maintaining them long enough to matter, and getting them into
  ecosystems like conda-forge, Keras, and TensorBoard
- **Data science** — the ML tooling line: [[../projects/pycm|PyCM — Multi-Class Confusion Matrix Library]], [[../projects/pymilo|PyMilo — Python Library for ML I/O]],
  [[../projects/memor|Memor — Conversational Memory Across LLMs]]
- **User research** — running studies on the tools and updating them on what the studies
  showed, most directly with [[../projects/nafas|Nafas — Breathing Gymnastics Application]]
- **Technical writing** — the reports that document the tools and make their reasoning
...
[[../honors-and-awards/psf-grant-art|PSF Software Development Grant — Art]] · [[../honors-and-awards/psf-grant-nava|PSF Software Development Grant — Nava]] · [[../honors-and-awards/nlnet-grant-pycm|NLnet Foundation Grant — PyCM]] · [[../honors-and-awards/trelis-grant-pycm|Trelis AI Micro-Grant — PyCM]] — grants funding work under this umbrella.
